...
(
    ...
    SURVEY_ANSWER,
    # Phase 3: Custom Survey Builder states
    CREATE_SURVEY_NAME, CREATE_SURVEY_DESC,
    ADD_QUESTION_TYPE, ADD_QUESTION_TEXT, ADD_QUESTION_CONFIG,
    EDIT_SURVEY_SELECT, EDIT_QUESTION_SELECT,
